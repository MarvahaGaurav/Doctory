        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <!-- Column -->
                        <div class="card"> <img class="" src="assets/images/background/profile-bg3.jpg" alt="Card image cap">
                            <div class="card-body little-profile text-center">
                                <div class="pro-img"><img src="assets/images/users/4.jpg" alt="user" /></div>
                                <h3 class="m-b-0">Admin Name</h3>
                                <div class="row text-center m-t-20">
                                    <div class="col-lg-6 col-md-6 m-t-20">
                                        <h3 class="m-b-0 font-light">9897764645</h3><small>Mobile</small></div>
                                    <div class="col-lg-6 col-md-6 m-t-20">
                                        <h3 class="m-b-0 font-light">Delhi</h3><small>Location</small></div>
                                    ...
                                    <ul class="product-review">
                                        <li>
                                            ...
                                            <div class="dl m-l-10">
                                                ...
                                                <h6 class="card-subtitle">www.linkedin.com/546337</h6> 
                                            </div>
                                            <div class="progress">
                                        ...
                                        <li>
                                            ...
                                            <div class="dl m-l-10">
                                                <h3 class="card-title">admin@admin.com</h3>
                                        ...
                                        <li>
                                            ...
                                            <div class="dl m-l-10">
                                                <h3 class="card-title">admin@twitter.com</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                     <div class="form-actions">
                        ...
                        <a href="changePswd.php" class="btn btn-inverse">Change password</a>
                    </div>
                  </div>
                </div>
                <!-- ============================================================== -->
