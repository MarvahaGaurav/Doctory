...
class Controller extends BaseController
{
   ...
   public function getUserDetail($data){
   	...
   	if($data->user_type == 1){ // doctor
   		...
   		$doctor_availabilities_day1 = $this->DoctorAvailability($data->id,1);
   		$doctor_availabilities_day2 = $this->DoctorAvailability($data->id,2);
   		$doctor_availabilities_day3 = $this->DoctorAvailability($data->id,3);
   		$doctor_availabilities_day4 = $this->DoctorAvailability($data->id,4);
   		$doctor_availabilities_day5 = $this->DoctorAvailability($data->id,5);
   		$doctor_availabilities_day6 = $this->DoctorAvailability($data->id,6);
   		$doctor_availabilities_day7 = $this->DoctorAvailability($data->id,7);
   		...
   		$day1 = $this->doctor_availabilities($doctor_availabilities_day1,$dates,$days,'day1'); 
			$day2 = $this->doctor_availabilities($doctor_availabilities_day2,$dates,$days,'day2'); 
			$day3 = $this->doctor_availabilities($doctor_availabilities_day3,$dates,$days,'day3'); 
			$day4 = $this->doctor_availabilities($doctor_availabilities_day4,$dates,$days,'day4'); 
			$day5 = $this->doctor_availabilities($doctor_availabilities_day5,$dates,$days,'day5'); 
			$day6 = $this->doctor_availabilities($doctor_availabilities_day6,$dates,$days,'day6'); 
			$day7 = $this->doctor_availabilities($doctor_availabilities_day7,$dates,$days,'day7'); 
			

			dd($day5);
			dd($doctor_availabilities_day5);


			$this->doctor_availabilities();
   ...
   public function doctor_availabilities($doctor_availabilities,$dates,$days,$arr_count){
   	// dd($arr_count);
		$day1 = []; 
		$day2 = []; 
		$day3 = []; 
   ...
   public function DoctorAvailability($drId,$dayId){
   	return DoctorAvailability::Where(['doctor_id' => $drId ,'day_id'=> $dayId])->orderBy('time_slot_id','asc')->get();
   }
